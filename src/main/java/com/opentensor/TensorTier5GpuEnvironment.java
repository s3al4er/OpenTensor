 ...
 * VRAM buffers, resolution/depth management, ...), with fixed Tier 5
 * specs: 380x120 resolution, 16-bit color, Tier-3-class call budget scaled
 * by the card, and VRAM of {@code totalMemory} = 45600 cells *
 * {@code vramScreens}.</p>
 *
 * <p>Integration with OpenComputers happens exclusively through the public
 * driver API: the environment is instantiated by {@link TensorTier5Driver} and
 ...
 */
public final class TensorTier5GpuEnvironment extends AbstractManagedEnvironment implements DeviceInfo {
    /** Maximum resolution of Tier 5 cards (twice OC Tier 3 each axis). */
    ...
    public static final int MAX_CELLS = MAX_WIDTH * MAX_HEIGHT; // 45600
    /** Maximum color depth of Tier 5 cards (matches OC Tier 4). */
